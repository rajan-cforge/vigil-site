// GitHub octicon, inlined because lucide-react removed brand icons
// (trademark concerns) and the dispatch's single-new-dep constraint
// precludes adding simple-icons or any brand-icon library.
//
// Pre-extracted ahead of Phase 3's FooterSection second use site
// (avoids a refactor mid-phase).
